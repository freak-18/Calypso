...
const rows = [
  ...
  { pkg: "Maintenance",      best: "Ongoing site care",                          price: "On request / mo",  hot: false },
];
    ...
    <section id="pricing" className="relative py-16 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <Reveal delay={100} variant="flip">
          <div className="surface-card mt-10 overflow-hidden rounded-[2rem] sm:mt-14">
            {/* Desktop header row */}
            ...
            {rows.map((r, i) => (
              <Reveal key={r.pkg} delay={i * 60}>
                <div
                  className={`group relative border-b border-border/40 px-5 py-5 transition-all duration-400 last:border-0 sm:px-8 sm:py-6 ${
                    r.hot ? "bg-primary/5 border-l-2 border-l-primary" : "hover:bg-surface/60"
                  }`}
                >
                  {/* Shimmer */}
                  ...
                  <div className="flex flex-col gap-1 sm:hidden">
                    <div className="flex items-center gap-2">
                      ...
                      <p className={`font-display text-sm font-semibold ${r.hot ? "text-primary" : ""}`}>{r.pkg}</p>
                      {r.hot && (
                    ...
                    <p className="text-xs text-muted-foreground">{r.best}</p>
                    <p className={`font-display text-sm font-semibold ${r.hot ? "text-gradient-teal" : "text-primary"}`}>
                      {r.price}
                    </p>
                  </div>

                  {/* Desktop layout: grid */}
                  <div className="hidden sm:grid sm:grid-cols-[1.1fr_1.6fr_0.9fr] sm:items-center sm:gap-4">
                    ...
                    <p className={`font-display text-sm font-semibold text-right ${r.hot ? "text-gradient-teal" : "text-primary"}`}>
                      {r.price}
                    </p>
                  </div>
                </div>
        ...
        <Reveal delay={160}>
          <div className="mt-8 flex flex-col items-center gap-5 px-2 text-center sm:gap-6">
